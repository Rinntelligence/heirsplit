...
VALUES
  ('deed0001-0000-0000-0000-000000000001', auth.uid(),                                          'admin'),
...
INSERT INTO interests (item_id, user_id, reason) VALUES
  ('face0001-0000-0000-0000-000000000001', auth.uid(),
...
INSERT INTO interests (item_id, user_id, reason) VALUES
  ('face0004-0000-0000-0000-000000000004', auth.uid(),
...
INSERT INTO interests (item_id, user_id, reason) VALUES
  ('face0008-0000-0000-0000-000000000008', auth.uid(),
